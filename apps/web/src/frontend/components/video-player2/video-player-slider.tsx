  ...
  return (
    ...
    >
      <div
        ...
        onPointerEnter={() => UI.startHoveringPreview()}
        onPointerMove={(e) => UI.setPreviewX(e.clientX)}
        onPointerLeave={() => UI.stopHoveringPreview()}
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();
        }}
      ...
      >
        ...
        <div
          ...
          ref={sliderButtonRef}
          className="flex justify-center items-center absolute left-0 origin-left will-change-transform transform-[translateX(0px)] -translate-x-1/2"
        >
